-- This routine is only usable for SQL 2005, and will grant the permissions required for running the extra Blocking Tracking
-- tracing functionality added to the SQL Tracing environment. To run this script you will have to login to Query Analyzer 
-- as someone with sufficient rights to grant permissions to objects within the MSDB database.
--
